...
declare module Backbone {
    ...
    interface on { (eventName: string, callback: (...args: any[]) => void, context?: any): Events; }
    interface off { (eventName?: string, callback?: (...args: any[]) => void, context?: any): Events; }
    interface trigger { (eventName: string, ...args: any[]): Events; }
    interface once { (eventName: string, callback: (...args:any[]) => void, context?: any): Events; }
    interface listenTo { (other: Events, eventName: string, callback: (...args:any[]) => void): Events; }
    interface stopListening { (other?: Events, eventName?: string, callback?: (...args:any[]) => void): Events; }
    interface listenToOnce { (other: Events, eventName: string, callback: (...args:any[]) => void): Events; }
    ...
    declare class Events {
        ...
        once(eventName: string, callback: (...args:any[]) => void, context?: any): Events;
        listenTo(other: Events, eventName: string, callback: (...args:any[]) => void): Events;
        stopListening(other?: Events, eventName?: string, callback?: (...args:any[]) => void): Events;
        listenToOnce(other: Events, eventName: string, callback: (...args:any[]) => void): Events;
    }
    ...
    export class Collection extends ModelBase {
        ...
        model: { new (attributes?: any, options?: any) : Model; };
        models: any;
        collection: Model;
        length: number;
